...
impl StructureLayoutField {
        ...
        match &self.data_type {
            ...
            _ => {
                ...
                quote!(
                    ...
                    string_parts.push(format!(#format_string, keramics_core::formatters::debug_format_array(&array_parts)));
                )
            }
        }
    }
    ...
    pub fn get_type_token_stream(&self) -> TokenStream {
        match &self.data_type {
            ...
            DataType::Ucs2String => quote!(keramics_types::Ucs2String),
            DataType::Utf16String => quote!(keramics_types::Utf16String),
            ...
            DataType::Uuid => quote!(keramics_types::Uuid),
            _ => panic!("Unsupported data type"),
        }
    }
    ...
    fn test_generate_debug_read_data_with_sequence_field() {
        ...
        let expected_token_stream = quote! {
            pub fn debug_read_data(data: &[u8]) -> String {
                ...
                string_parts.push(format!("    field2: {},\n", keramics_core::formatters::debug_format_array(&array_parts)));
