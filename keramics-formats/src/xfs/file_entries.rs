...
/// XFS file entries iterator.
pub struct XfsFileEntriesIterator<'a> {
    /// File entry.
    file_entry: &'a mut XfsFileEntry,
...
impl<'a> XfsFileEntriesIterator<'a> {
    /// Creates a new iterator.
    pub fn new(file_entry: &'a mut XfsFileEntry) -> Self {
        Self {
            file_entry,
...
impl<'a> Iterator for XfsFileEntriesIterator<'a> {
    type Item = Result<XfsFileEntry, ErrorTrace>;
