...
impl NtfsMftAttributes {
    ...
    /// Retrieves a specific attribute.
    pub fn get_attribute_by_name_and_type(
        &self,
    ...
    pub fn get_data_stream_by_name(
        ...
        let data_attribute: &NtfsMftAttribute =
            match self.get_attribute_by_name_and_type(name, NTFS_ATTRIBUTE_TYPE_DATA) {
        ...
        if let Some(compression_method) = wof_compression_method {
            ...
            let wof_data_attribute: &NtfsMftAttribute = match self
                .get_attribute_by_name_and_type(&Some(attribute_name), NTFS_ATTRIBUTE_TYPE_DATA)
            {
...
mod tests {
    ...
    use crate::ntfs::mft_entry::NtfsMftEntry;
    ...
    fn get_mft_attributes() -> Result<NtfsMftAttributes, ErrorTrace> {
        let mut test_data: Vec<u8> = get_test_data();

        let mut mft_entry = NtfsMftEntry::new();
        mft_entry.read_data(&mut test_data)?;

        mft_entry.data = test_data;
    ...
    fn test_get_number_of_attributes() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let number_of_attributes: usize = mft_attributes.get_number_of_attributes();
    ...
    #[test]
    fn test_get_attribute_by_index() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let mft_attribute: &NtfsMftAttribute = mft_attributes.get_attribute_by_index(0)?;
        assert_eq!(
            mft_attribute.attribute_type,
            NTFS_ATTRIBUTE_TYPE_STANDARD_INFORMATION
        );

        let result: Result<&NtfsMftAttribute, ErrorTrace> =
            mft_attributes.get_attribute_by_index(99);
    ...
    #[test]
    fn test_get_attribute_by_name_and_type() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let attribute_name: Option<Ucs2String> = None;
        let mft_attribute: &NtfsMftAttribute = mft_attributes
            .get_attribute_by_name_and_type(
                &attribute_name,
                NTFS_ATTRIBUTE_TYPE_STANDARD_INFORMATION,
            )
            .unwrap();
        ...
        let attribute_name: Option<Ucs2String> = Some(Ucs2String::from("$I30"));
        let result: Option<&NtfsMftAttribute> = mft_attributes
            .get_attribute_by_name_and_type(&attribute_name, NTFS_ATTRIBUTE_TYPE_INDEX_ROOT);
    ...
    #[test]
    fn test_get_attribute_group() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let group_name: Option<Ucs2String> = Some(Ucs2String::from("$I30"));
        let result: Option<&NtfsMftAttributeGroup> =
            mft_attributes.get_attribute_group(&group_name);
        assert!(result.is_none());
    ...
    #[test]
    fn test_has_attribute_group() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let group_name: Option<Ucs2String> = Some(Ucs2String::from("$I30"));
        let result: bool = mft_attributes.has_attribute_group(&group_name);
    ...
    #[test]
    fn test_get_number_of_data_attributes() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let number_of_attributes: usize = mft_attributes.get_number_of_data_attributes();
    ...
    #[test]
    fn test_get_data_attribute_by_index() -> Result<(), ErrorTrace> {
        let mft_attributes: NtfsMftAttributes = get_mft_attributes()?;

        let mft_attribute: &NtfsMftAttribute =
            mft_attributes.get_data_attribute_by_index(0).unwrap();
        assert_eq!(mft_attribute.attribute_type, NTFS_ATTRIBUTE_TYPE_DATA);

        let result: Option<&NtfsMftAttribute> = mft_attributes.get_data_attribute_by_index(99);
        assert!(result.is_none());
